                                                ...
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>₱ '.number_format($row['samount'],2).'</td>
                                                            ...
                                                            <td><a class="btn btn-primary btn-sm" href="/pages/clearance/fpdf/generate_indigency_cert.php?resident_id='.$row['residentid'].'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Generate</a></td>
                                                    </tr>
