                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;" div class= "pull-right">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal" style="background-color: green"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Clearance</button>  
                                                    ...
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>₱ '.number_format($row['samount'],2).'</td>
                                                                ...
                                                                <td><a class="btn btn-primary btn-sm" href="/pages/clearance/fpdf/generate_clearance.php?resident_id='.$row['residentid'].'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Generate</a></td>
