                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;" div class= "pull-right">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addCourseModal" style="background-color: green"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Officials</button>  
                                                ...
                                                if(!isset($_SESSION['staff']))
                                                {
                                                    ...
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>'.$row['termEnd'].'</td>
                                                            <td>
                                                                <button class="btn btn-primary btn-sm" data-target="#editModal'.$row['id'].'" data-toggle="modal" style="background-color: #556B2F"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>';
